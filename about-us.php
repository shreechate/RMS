     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">HIRE ME</a>
               </div>
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead"><p class="lead">HELLO!!</p>
                                   <p class="lead">This is HIRE ME, to provide you with the best services for your favourite jobs.<br>
                                   It provides you with job applications .<br>
                                   This is among the most successful websites for providing jobs and followed by so many people.<br>
                                   It is trusted by many customers and clients .<br>
                                   We are working here since 2000.</p>
               </div>
          </div>
     </section>
