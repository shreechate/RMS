          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12">
                         <div>
                              ...
                              <img src="images/53.png" alt="" class="img-responsive wc-image">
                    ...
                    <div class="col-lg-9 col-md-9 col-xs-12">
                         <form action="#" method="post" class="form">
                              ...
                              <p class="lead"><strong class="text-primary"></strong> </p>
               ...
               <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         <!-- per<p>Pro Active Retail Security Officer required to operate in luxury retail environment. Searching for self-motivated individuals who are always looking to achieve the highest standards.</p> -->

                         <h4>SKILL REQUIRED:</h4>

                         <p> Being patient<br></p>
                              <p>Vigilant to every detail<br></p>
                              <p>Analytical reasoning<br></p>
                          <p> Communication skills<br></p>
                         <p> Problem-solving skills</p>

                         <h4>Salary:</h4>
                         <p>- The average salary of a Software Developer is INR 10.1 LPA..</p>
